...
=======
    ...
    },
    {
      ...
      path: '/calendar',
      icon: (
        <svg width="25" height="24" viewBox="0 0 25 24" className="nav-icon" style={{ marginBottom: '2px' }}>
>>>>>>> 7c3e732616e2a2bac02f332c59fcab71c3e45267
          <path
...
>>>>>>> 7c3e732616e2a2bac02f332c59fcab71c3e45267
          <path
            d="M15.6293 16.7L17.0293 15.3L13.3293 11.6V7H11.3293V12.4L15.6293 16.7ZM12.3293 22C10.946 22 9.64601 21.7375 8.42935 21.2125C7.21268 20.6875 6.15435 19.975 5.25435 19.075C4.35435 18.175 3.64185 17.1167 3.11685 15.9C2.59185 14.6833 2.32935 13.3833 2.32935 12C2.32935 10.6167 2.59185 9.31667 3.11685 8.1C3.64185 6.88333 4.35435 5.825 5.25435 4.925C6.15435 4.025 7.21268 3.3125 8.42935 2.7875C9.64601 2.2625 10.946 2 12.3293 2C13.7127 2 15.0127 2.2625 16.2293 2.7875C17.446 3.3125 18.5043 4.025 19.4043 4.925C20.3043 5.825 21.0168 6.88333 21.5418 8.1C22.0668 9.31667 22.3293 10.6167 22.3293 12C22.3293 13.3833 22.0668 14.6833 21.5418 15.9C21.0168 17.1167 20.3043 18.175 19.4043 19.075C18.5043 19.975 17.446 20.6875 16.2293 21.2125C15.0127 21.7375 13.7127 22 12.3293 22ZM12.3293 20C14.546 20 16.4335 19.2208 17.9918 17.6625C19.5502 16.1042 20.3293 14.2167 20.3293 12C20.3293 9.78333 19.5502 7.89583 17.9918 6.3375C16.4335 4.77917 14.546 4 12.3293 4C10.1127 4 8.22518 4.77917 6.66685 6.3375C5.10851 7.89583 4.32935 9.78333 4.32935 12C4.32935 14.2167 5.10851 16.1042 6.66685 17.6625C8.22518 19.2208 10.1127 20 12.3293 20Z"
            fill="#49454F"
          />
        </svg>
      ),
...
<<<<<<< HEAD
        ...
        >
          ...
          <span>{item.name}</span>
          {activeTab === item.name && <div className={styles.div38} />}
=======
